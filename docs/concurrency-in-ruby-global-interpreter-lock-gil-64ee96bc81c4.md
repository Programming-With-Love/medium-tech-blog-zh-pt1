# Ruby 中的并发性:全局解释器锁(GIL)

> 原文：<https://medium.com/double-pointer/concurrency-in-ruby-global-interpreter-lock-gil-64ee96bc81c4?source=collection_archive---------0----------------------->

本课讨论全局解释器锁，也称为 GIL 及其影响。
