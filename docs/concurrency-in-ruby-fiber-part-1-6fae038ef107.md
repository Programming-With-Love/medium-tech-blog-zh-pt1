# Ruby: Fiber 中的并发性(第 1 部分)

> 原文：<https://medium.com/double-pointer/concurrency-in-ruby-fiber-part-1-6fae038ef107?source=collection_archive---------3----------------------->

本课介绍了 Ruby 中纤程的概念，从某种意义上来说，它相当于协程。
