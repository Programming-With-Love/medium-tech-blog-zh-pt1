# Ruby 中的并发性:异步编程(第 1 部分)

> 原文：<https://medium.com/double-pointer/concurrency-in-ruby-async-programming-part-1-9db33073baf9?source=collection_archive---------1----------------------->

本课介绍了异步编程作为一种重要编程范式的概念。
